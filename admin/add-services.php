...
<html>
<head>
<title>Museo | Agregar Servicios</title>
...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Nombre de Servicio</label> <input type="text" class="form-control" id="sername" name="sername" placeholder="Nombre de Servicio" value="" required="true"> </div> <div class="form-group">  </div>

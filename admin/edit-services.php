...
<html>
<head>
<title>Museo | ACTUALIZAR SERVICIOS</title>
				...
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Actualizar Servicios Museo:</h4>
						</div>
						<div class="form-body">
							<form method="post">
...
?> 
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Nombre Servicio</label> <input type="text" class="form-control" id="sername" name="sername" placeholder="Nombre Servicio" value="<?php  echo $row['ServiceName'];?>" required="true"> </div> 

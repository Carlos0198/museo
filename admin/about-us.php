...
$pagedes=$_POST['pagedes'];
    ...
    if ($query) {
    $msg="Tu página Acerca de, ha sido actualizada satisfactoriamente.";
  }
  else
    {
	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Actualizar Acerca de</h3>

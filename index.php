...
<html lang="en">
  ...
  <body>
    ...
    <section id="home-section" class="hero" style="background-image: url(images/museo/fondo1.jpg);" data-stellar-background-ratio="0.5">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
		          		<span class="subheading">Obras de Artes</span>
			            <h1 class="mb-4">Arte Bella</h1>
			            <p class="mb-4">Nos enorgullecemos de nuestro trabajo de alta calidad y atencion al cliente.</p>
	          ...
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
			            ...
			            <h1 class="mb-4">Salon de Colecciones</h1>
			            <p class="mb-4">El Museo ofrece una cantidad de obras de la mejor calidad.Un recorrido de todas las obras que nunca has experimentado antes.</p>
    	...
    	<div class="container-fluid px-0">
    		<div class="row no-gutters d-md-flex justify-content-end">
    				...
    				<div class="text">
    					...
    					<div class="appointment-wrap">
    						<span class="subheading">Reservaciones</span>
								<h3 class="mb-2">Agenda tu Visita</h3>
              ...
              ?>
					...
					<div class="one-third">
						<div class="img" style="background-image: url(images/museo/principal.png);">
						</div>
					</div>
    		</div>
    	</div>
